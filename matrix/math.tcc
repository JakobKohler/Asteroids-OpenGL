...
template <class FLOAT_TYPE, size_t N>
FLOAT_TYPE operator*(Vector<FLOAT_TYPE, N> vector1, Vector<FLOAT_TYPE, N> vector2) {
  FLOAT_TYPE scalar_product = 0.0f;
  for (size_t i = 0u; i < N; i++) {
...
template<class FLOAT_TYPE, size_t N>
Vector<FLOAT_TYPE, N>::Vector() = default;
